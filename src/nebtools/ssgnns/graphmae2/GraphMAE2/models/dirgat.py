...
class RossiDirGAT(nn.Module):
    def __init__(
        ...
        super(RossiDirGAT, self).__init__()
...
class OneDirGATConv(nn.Module):
    def __init__(
        ...
        *,
        ...
        super(OneDirGATConv, self).__init__()
...
class RossiDirGATConv(nn.Module):
    def __init__(
        self,
        in_feats,
        out_feats,
        ...
        *,
        ...
        super(RossiDirGATConv, self).__init__()

        self.fwd_dir_gat_conv = OneDirGATConv(
            in_feats=in_feats,
            out_feats=out_feats,
            num_heads=num_heads,
            feat_drop=feat_drop,
        ...
        self.bwd_dir_gat_conv = OneDirGATConv(
            in_feats=in_feats,
            out_feats=out_feats,
            num_heads=num_heads,
            feat_drop=feat_drop,
    ...
    def forward(self, graph, feat):
        fwd_rst = self.fwd_dir_gat_conv(graph, feat)
        bwd_rst = self.bwd_dir_gat_conv(graph.reverse(), feat)
        rst = self.alpha * fwd_rst + (1 - self.alpha) * bwd_rst
        if self.activation:
